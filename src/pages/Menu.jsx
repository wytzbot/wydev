...
import {Home,GitBranch,Clock3,GitCompare,Search,Settings,HelpCircle,LogOut,CreditCard} from "lucide-react";
export default function Menu({page,setPage,onLogout,onSearch}){
 ...
 const items=[["home","Home",Home],["repos","Repositories",GitBranch],["recent","Recent Projects",Clock3],["changes","Changes",GitCompare],["search","Search",Search],["billing","Billing",CreditCard],["settings","Settings",Settings],["help","Help",HelpCircle]];

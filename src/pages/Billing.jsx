...
export default function Billing(){
 ...
 const verify=async(id,reference)=>{
   ...
   setErr("Payment is still processing. Complete the bank authorization and Wyte will activate Pro automatically.");
   return false;
 };

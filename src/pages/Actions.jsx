...
export default function Actions({repos}){
 ...
 if(!repo)return <div className="page"><header><div><span className="eyebrow">ACTIONS</span><h1>Actions Control Center</h1></div></header><section className="panel"><p className="muted">Create or open a GitHub repository first. WyDev will show its workflow runs here.</p></section></div>;
